...
START_TEST(test_incorrect_matrix)
{
#line 16
...
START_TEST(test_create_calloc1)
{
#line 28
    matrix_t m;
...
START_TEST(test_21_sub_invalid_size)
{
#line 183
matrix_t A, B, result;
    s21_create_matrix(2, 2, &A); // 2x2
...
START_TEST(test_s21_mult_matrix_correct)
{
#line 214
    matrix_t A, B, result;
...
START_TEST(test_s21_mult_matrix_incorrect)
{
#line 239
    matrix_t A, B, result;
...
START_TEST(test_21_mult_number_2)
{
#line 272
...
int main(void)
{
    ...
    tcase_add_test(tc1_1, test_create_matrix);
    tcase_add_test(tc1_1, test_incorrect_matrix);
    tcase_add_test(tc1_1, test_create_calloc);
    tcase_add_test(tc1_1, test_create_calloc1);
    tcase_add_test(tc1_1, test_remove_matrix);
    tcase_add_test(tc1_1, test_s21_eq_matrix);
    tcase_add_test(tc1_1, test_s21_eq_matrix_identical);
    tcase_add_test(tc1_1, test_s21_eq_matrix_different_values);
    tcase_add_test(tc1_1, test_s21_sum_matrix_valid);
    tcase_add_test(tc1_1, test_s21_sum_matrix_invalid_size);
    tcase_add_test(tc1_1, test_s21_sub_matrix);
    tcase_add_test(tc1_1, test_21_sub_invalid_size);
    tcase_add_test(tc1_1, test_s21_mult_matrix_correct);
    tcase_add_test(tc1_1, test_s21_mult_matrix_incorrect);
    tcase_add_test(tc1_1, test_s21_mult_number_1);
    tcase_add_test(tc1_1, test_21_mult_number_2);
